...
def home(request):
    return render(request, 'app_do_homi/home.html')

def produtos(request):
    produtos = Produto.objects.filter(disponivel=True)
    return render(request, 'app_do_homi/produtos.html', {'produtos': produtos})

def contatos(request):
    return render(request, 'app_do_homi/contatos.html')
...
def add_produto(request):
    if request.method == 'POST':
        ...
        form = ProdutoForm()
    return render(request, 'app_do_homi/add_produto.html', {'form': form})
